...
@author: MarcHansen
"""
#This compares the error of the approx. in pol. reg. and softplus reg.. Change the orders of the models in line 57 and 96
...
for N in range(1,N+1):
    ...
    plt.figure(0)
    #Bachelier payoff
    Price_error[N-1] = round(np.mean(abs(y-CallPrice)),8)
    Delta_error[N-1] = round(np.mean(abs(delta-Bach_CallDelta)),8)
