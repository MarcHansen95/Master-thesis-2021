...
blue_patch = mpatches.Patch(color='blue', label='4th deg. pol. reg.')
...
plt.title('Option Price with N = 1')
plt.grid(b=True, which='major', color='#666666', linestyle='-')
plt.savefig('Option_price_soft_n1_BS.png')
...
plt.ylim(-0.2,2)
plt.title('Option Delta with N = 1')
yellow_patch = mpatches.Patch(color='yellow', label='SoftPlus reg.')
blue_patch = mpatches.Patch(color='blue', label='4th. deg. poly reg.')
black_patch = mpatches.Patch(color='black', label='Black-Scholes')
plt.legend(handles=[yellow_patch,black_patch,blue_patch])
plt.grid(b=True, which='major', color='#666666', linestyle='-')
...
plt.savefig('Option_delta_soft_n1_BS.png')